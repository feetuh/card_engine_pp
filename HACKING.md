...
hidden if the `card_engine_pp_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `card_engine_pp_DEVELOPER_MODE` to the configure
